...
import 'package:qast/screens/delivery/delivery_dashboard_screen.dart';
                  ...
                  child: BackdropFilter(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Icon(Icons.delivery_dining, size: 80, color: Colors.deepOrangeAccent),
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [Colors.deepOrange, Colors.orangeAccent], // Tonos naranjas para delivery
