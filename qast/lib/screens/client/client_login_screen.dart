...
import 'package:qast/screens/client/client_profile_setup_screen.dart';
...
class _ClientLoginScreenState extends State<ClientLoginScreen> {
  ...
  void _verificarOTP() {
    if (_otpController.text.length == 6) {
      // Si el usuario es nuevo y no tiene nombre, vamos al setup. 
      // Por ahora forzamos ir al setup para cumplir el flujo.
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => ClientProfileSetupScreen(telefono: _telefonoController.text)),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [Colors.lightBlue, Colors.blueAccent], // Tonos azules para clientes
